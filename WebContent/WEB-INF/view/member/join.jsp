                            ...
                            <tbody>                                
                                <tr>
                                    ...
                                    <td colspan="3" class="text-align-left indent">
                                      ...
                                      <!--   <input class="btn-text btn-default" type="button" id="id-check-button" value="중복확인" />		 -->						
                                        <input class="btn-text btn-default" type="submit" name="cmd" value="중복확인" style="height: 30px; margin:20px;"/>						
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <input id="submit-Button" type="submit" name="cmd" value="확인" style="height: 30px; margin:20px;" class="btn-text btn-default" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
