		...
		<ul>
            ...
            <main>
                ...
                <div class="margin-top first" style="background: url('../images/member/bg-login.png') no-repeat center;height: 277px;">
                    ...
                    <div class="text-align-center">
                        <a class="btn" style="margin-left:170px; margin-top:50px;display:inline-block;width:83px;height: 53px;background: url('../images/member/btn-login.png') no-repeat center;" href="login">메인페이지로 이동합니다.</a>
                    </div>
                </div>
            </main>
